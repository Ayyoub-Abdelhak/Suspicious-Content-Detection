...
/**
 * @author Ayyoub Abdelhak This Class is based on The Porter Stemming Algorithm
...
public class Stemmer {
    ...
    public void stem(ArrayList<Tweet> tweets) {
        String tweet;
        String processedTweet;
        for (Tweet tw : tweets) {
            ArrayList<String> wordVector = new ArrayList<>();
            processedTweet = "";
            tweet = tw.getProcessedTweet();
            ...
            tw.setWordVector(wordVector);
            tw.setProcessedTweet(processedTweet);
        }
    }
